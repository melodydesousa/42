...
/*   Updated: 2022/08/12 13:10:28 by mede-sou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_save(char **save, int nb_octets)
{
	...
	new_save[j] = '\0';
	*save = new_save;
	return (free(temp_save), new_save);
}
...
char	*get_next_line(int fd)
{
	...
	line = ft_line(save, ft_strlen_gnl(save));
	save = ft_save(&save, ft_strlen_gnl(save));
	return (line);
}
