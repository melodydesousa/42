...
void	map_parsing2(t_data *d)
{
	if (d->tab[d->tab_y][d->tab_x] == '1')
		mlx_put_image_to_window(d->mlx, d->win, d->img_wa, d->x * N, d->y * N);
	else if (d->tab[d->tab_y][d->tab_x] == '0')
		mlx_put_image_to_window(d->mlx, d->win, d->img_gr, d->x * N, d->y * N);
	else if (d->tab[d->tab_y][d->tab_x] == 'C')
		mlx_put_image_to_window(d->mlx, d->win, d->img_cor, d->x * N, d->y * N);
	else if (d->tab[d->tab_y][d->tab_x] == 'P')
		mlx_put_image_to_window(d->mlx, d->win,
			d->img_ch, d->x_p * N, d->y_p * N);
	else if (d->tab[d->tab_y][d->tab_x] == 'E')
		mlx_put_image_to_window(d->mlx, d->win, d->img_co, d->x * N, d->y * N);
	d->tab_x++;
	d->x++;
}
