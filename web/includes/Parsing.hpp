...
/*   Updated: 2023/03/15 16:52:14 by mede-sou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Parsing {
    public:
        ...
        void setVecServer();
        Server* createNewServer(std::vector<std::string>::iterator it);
...
void check_brackets(std::vector<std::string> vec);
...
void check_doublon_kw(std::vector<std::string> vec_kw);
